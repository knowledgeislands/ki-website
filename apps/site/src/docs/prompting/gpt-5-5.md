...
How to prompt OpenAI's GPT-5.5, the current flagship of the GPT-5 line. Read the shared [Prompting guides](/docs/prompting/) principles first; this guide carries only what is distinctive to GPT-5.5. This guide is reference for cross-model work: building on, targeting, or evaluating GPT-5.5.
