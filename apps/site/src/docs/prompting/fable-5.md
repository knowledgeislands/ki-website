...
How to prompt Claude Fable 5 (and its safeguard-free sibling Mythos 5). Read the shared [Prompting guides](/docs/prompting/) principles first; this guide carries only what is distinctive to Fable 5.
