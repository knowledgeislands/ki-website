...
How to prompt Google's Gemini 3 line (3.1 Pro, 3 Flash, 3.5 Flash). Read the shared [Prompting guides](/docs/prompting/) principles first; this guide carries only what is distinctive to Gemini 3. This guide is reference for cross-model work: building on, targeting, or evaluating Gemini 3.
