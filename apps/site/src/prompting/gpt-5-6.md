...
- **Everything in [Prompting OpenAI GPT-5.5](/prompting/gpt-5-5/) still applies** — the Responses API, `phase` field, verbosity param, and tool-preamble guidance are unchanged across the GPT-5 line.
