...
- The Website owns the public tooling guide under `/tooling/`; it replaces the unused `/harness/` page without a redirect. `tools-ki` owns executable behaviour and delivery, while the harness owns the reusable capability artefacts it publishes.
