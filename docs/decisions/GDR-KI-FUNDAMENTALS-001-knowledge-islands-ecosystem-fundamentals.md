...
- The Website owns the public account of each released tool under `/projects/<tool>/`. `tools-ki` owns executable behaviour and delivery, while the harness owns the reusable capability artefacts it publishes.
