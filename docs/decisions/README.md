...
6. [ADR-KI-WEBSITE-003](ADR-KI-WEBSITE-003-documentation-is-a-thing-you-work-through.md) - dissolves the guidance section and gathers everything that teaches into Docs sections a reader works through in order, leaving the project catalogue to answer what exists rather than how to use it.
