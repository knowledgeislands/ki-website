...
Make the KI Website the coherent public home for user, prompting, and cross-skill-composition guidance across the five core Knowledge Islands repositories.

The current distributed guide footprint is small but fragmented: `ki-agentic-harness` contains user, prompting, and developer guides; `tools-ki` contains user and developer guides; `ki-arcadia-principal`, `ki-specifications`, and `ki-website` have no `docs/guides/` tree today.
