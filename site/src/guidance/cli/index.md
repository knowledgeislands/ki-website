...
The installed executable owns exact, version-specific command grammar. Use `ki --help` or `ki <command> --help` before acting; the tracked [ki(1) manual](https://github.com/knowledgeislands/tools-ki/blob/main/man/ki.1) is the source representation maintained with the executable.
